    ...
    : QDialog(parent)
{
    ...
    ui.btnNetStatus->setStyleSheet("QPushButton{background-color:rgb(0, 0, 200);background-repeat: no-repeat;background-position:center;background-image:url(:/CLoginDlg/resources/login/login_netstatus);border:none}");
